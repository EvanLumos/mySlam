/*************************************************************************
    ...
    > Function:  create ponit cloud map by features detection and matching between two frame.
    > Created Time: 2018年10月16日 星期二
 ************************************************************************/
...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/raopei/mySlam/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/raopei/mySlam/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/raopei/mySlam/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/raopei/mySlam/data/depth2.png", -1 );
    ...
    *output += *cloud2;
    pcl::io::savePCDFile("/home/raopei/mySlam/data/result.pcd", *output);
